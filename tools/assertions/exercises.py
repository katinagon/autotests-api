...
from clients.exercises.exercises_schema import CreateExerciseRequestSchema, CreateExerciseResponseSchema, \
    ExerciseSchema, GetExerciseResponseSchema, UpdateExerciseResponseSchema, UpdateExerciseRequestShema, \
...
def assert_update_exercise_response(request: UpdateExerciseRequestShema, response: UpdateExerciseResponseSchema):
    """
