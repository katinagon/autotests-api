...
from clients.exercises.exercises_schema import GetExercisesQuerySchema, CreateExerciseRequestSchema, \
    UpdateExerciseRequestShema, GetExercisesResponseSchema, GetExerciseResponseSchema, CreateExerciseResponseSchema, \
...
class ExercisesClient(APIClient):
    ...
    def update_exercise_api(self, exercise_id: str, request: UpdateExerciseRequestShema) -> Response:
        """
    ...
    def update_exercise(self, exercise_id: str, request: UpdateExerciseRequestShema) -> UpdateExerciseResponseSchema:
